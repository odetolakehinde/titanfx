      ...
      <v-progress-circular indeterminate size="64"></v-progress-circular>
            ...
            <v-col class="text-left" lg="8" md="8" sm="12">
                ...
                <div v-for="user in users" :key="user.email" class="pb-3">
                    ...
                    <v-card-actions>
                        <v-btn @click="showForm('edit', user)" class="black--text" color="#ff0000" small>Edit</v-btn>
                    </v-card-actions>
                </v-card>
                </div>
            </v-col>
        ...
        <v-dialog v-model="form" max-width="450" height="500">
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-btn :loading="loading" block @click="editUser" v-if="showEditButton" class="white--text" color="#ff0000">Edit User</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
